...
```{R}
Get_Networks <- function(file, Norm = "RAW"){
  wb <- loadWorkbook(file)
  n <- c(1:17)
  Years <- c(2000:2016)
  Years <- paste0("SchoolDecileGender_TertiaryDiscipline_Year",Years)
  ...
  for(i in n){
      ...
      #save as pdf
      pdf(paste0("G:/My Drive/StevenTurnbull_PhD/Datalab/20180515_matrices/Analysis/Networks/",Years[i],"_",Norm,"_Network.pdf"))
      #Make plot
          plot(g
      ...
      #              out_file = paste0("G:/My Drive/StevenTurnbull_PhD/Datalab/20180515_matrices/Analysis/Heatmaps/",Years[i],"_",Norm,"_Heatmap.png"))
      # 
      ...
      ggsave(plot = HeatMap, file = paste0("G:/My Drive/StevenTurnbull_PhD/Datalab/20180515_matrices/Analysis/Heatmaps/",Years[i],"_",Norm,"_Heatmap.pdf"))
